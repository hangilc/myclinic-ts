...
describe("futan/calc-nanbyou", () => {
  it("should calc basic case", () => {
    ...
    const bill = 2000;
    calcPayments(bill, [shaho], { futanWari: 3 });
  ...
  it("should handle nanbyou with futanWari 3", () => {
    ...
    const bill = 2000;
    calcPayments(bill, [hoken, nanbyou], { futanWari: 3 });
  ...
  it("should handle nanbyou with futanWari 2", () => {
    ...
    const nanbyou = mkKouhiNanbyou(5000);
    const bill = 2000;
    calcPayments(bill, [hoken, nanbyou], { futanWari: 2 });
  ...
  it("should handle nanbyou with futanWari 1", () => {
    ...
    const nanbyou = mkKouhiNanbyou(5000);
    const bill = 2000;
    calcPayments(bill, [hoken, nanbyou], { futanWari: 1 });
