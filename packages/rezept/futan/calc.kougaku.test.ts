import { PayerObject, PaymentObject, calcPayments, mkHokenPayer, mkKouhiKekkaku, mkKouhiMarucho, totalJikofutanOf } from "./calc";
...
describe("高額療養費（70歳未満）", () => {
  ...
  it("事例13　本人入院（標準報酬月額83万円以上）・公費（結核患者の適正医療）", () => {
    ...
    const pay1 = calcPayments(6000*10, [hoken, kouhi], { shotokuKubun: "ア" });
    const pay2 = calcPayments(9000*10, [hoken], {});
