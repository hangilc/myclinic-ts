...
import { calcFutan, KouhiKekkaku, KouhiKouseiIryou, KuniNanbyou, KuniSeishinTsuuin, MarutoNanbyou, SeikatsuHogo, TotalCover, type HokenSelector, type KouhiData, type KouhiProcessorArg } from "./futan-calc";
