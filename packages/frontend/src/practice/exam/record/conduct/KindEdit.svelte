<script lang="ts">
  ...
  let show = false;
  let selected: Writable<ConductKindType> = writable(ConductKindObject.fromTag(conduct.kind));
...
<div class="top">
  ...
  <div class="select">
    ...
    <SelectItem selected={selected} data={ConductKind[kindKey]}>
      {ConductKind[kindKey].rep}
    </SelectItem>
    {/each}
  </div>
  <div class="commands">
